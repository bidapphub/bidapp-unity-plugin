...
namespace UnityEditor.XCodeEditor
{
	public class XCBuildConfiguration : PBXObject
	{
		...
		protected bool AddSearchPaths( string path, string key, bool recursive = false )
		{
		...
		protected bool AddSearchPaths( PBXList paths, string key, bool recursive = false )
		{	
			bool modified = false;
...
//				Debug.Log( "adding: " + currentPath );
		...
		public bool AddHeaderSearchPaths( PBXList paths, bool recursive = false )
		{
			return this.AddSearchPaths( paths, HEADER_SEARCH_PATHS_KEY, recursive );
		}
		
		public bool AddLibrarySearchPaths( PBXList paths, bool recursive = false )
		{
			return this.AddSearchPaths( paths, LIBRARY_SEARCH_PATHS_KEY, recursive );
		}

		public bool AddFrameworkSearchPaths(PBXList paths, bool recursive = false)
		{
